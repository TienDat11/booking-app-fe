...
const UsersManager = () => {
  ...
  const handleUpdate = async () => {
    if (selectedUser) {
      ...
      await axios
        .put(
          url + '/v1/users/' + selectedUser.user_id,
          {
            user_name,
            email,
            phone_number,
          ...
          >
            <div style={{ padding: 20 }}>
              ...
              >
                ...
                >
                  <Input placeholder='Enter User Name' onChange={onAddName} />
                </Form.Item>
                ...
                <Form.Item
                  ...
                  hasFeedback
                >
                  <Input placeholder='Email' onChange={onAddEmail} />
                </Form.Item>
                <Form.Item
                  label='Phone Number'
                  name='phone_number'
            ...
            <div style={{ padding: 20 }}>
              ...
              >
                <Form.Item
                  ...
                  hasFeedback
                >
                  <Input onChange={onchangeName} value={user_name} />
                </Form.Item>
                <Form.Item
                  label='Email'
                  name='email'
                  rules={[
                    ...
                    {
                      pattern:
                        /^[\w-]+(\.[\w-]+)*@hotmail\.com$|^[\w-]+(\.[\w-]+)*@outlook\.com$|^[\w-]+(\.[\w-]+)*@gmail\.com$/,
